...
import BoxThemeSelector from '@/components/BoxThemeSelector';

// Définition des thématiques disponibles
type BoxTheme = 'Découverte' | 'Bourbon' | 'Tradition' | 'Saison';

// Extension de la structure des box pour inclure les thématiques
interface BoxData {
  id: number;
  baseTitle: string;
  price: number;
...
const Index = () => {
  ...
  const getSelectedBoxDetails = () => {
    ...
    // Créer un objet de box avec les informations de la thématique sélectionnée
  ...
  // Créer un titre pour afficher sur la BoxCard qui inclut la thématique
        ...
        <section className="py-8 bg-gray-100">
          <div className="container-section">
            <div className="text-center mb-8 fade-in">
              <h2 className="text-2xl font-bold mb-2">Choisissez votre thématique</h2>
