            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-12">
                ...
                <section>
                  ...
                  <div className="text-gray-700 space-y-4 leading-relaxed">
                    <p>KiltirBox ce sont des box de produits locaux selon des thématiques originales et culturelles à récupérer sur place à l'aéroport ou livrées en Métropole.</p>
