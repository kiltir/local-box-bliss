...
const BoxesSection = () => {
  ...
  return <>
      ...
      {getSelectedBoxDetails() && <BoxDetails title={getSelectedBoxDetails()!.title} price={getSelectedBoxDetails()!.price} description={getSelectedBoxDetails()!.description} image={getSelectedBoxDetails()!.image} products={getSelectedBoxDetails()!.products} onClose={handleCloseDetails} />}
    </>;
};
