  ...
  return <section className="bg-white my-0 py-0">
      <div className="container-section py-[30px]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Découvrez nos box de produits typiques issus du savoir-faire local, disponibles avant/après votre voyage ou livrées directement en Métropole.</p>
