      ...
      <div className="container-section py-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12 fade-in">
          <div className="text-center">
            ...
            <p className="text-gray-600">Sélectionnez la thématique de box qui vous convient selon vos goûts et vos envies.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-3">Nos box sont toujours soigneusement élaborées avec des produits originaux et de qualité pour vous émerveiller.</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-3">Récupérez votre box à l'aéroport avant ou après votre vol.</h3>
            <p className="text-gray-600">
