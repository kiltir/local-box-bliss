      ...
      <div className="container-section my-0 py-[30px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12 fade-in">
          <div className="text-center">
            ...
            <p className="text-gray-600">Sélectionnez la thématique de box parmi notre gamme selon vos goûts et vos envies.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Récupérez votre box à l'aéroport de Gillot de la Réunion avant ou après votre vol ou directement en Métropole.</p>
          </div>
        </div>
