  ...
  return <section className="hero-section py-16 md:py-24">
      <div className="container-section">
        <div className="max-w-3xl mx-auto text-center slide-in">
          ...
          <p className="text-xl text-gray-600 mb-8">Découvrez nos box de produits typiques, de saison et issus de partenaires locaux disponibles avant ou après votre voyage.</p>
