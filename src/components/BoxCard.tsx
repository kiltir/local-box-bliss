...
const BoxCard = ({ title, price, description, image, items, theme, rating, reviewCount, onClick, purchaseType = 'one-time' }: BoxCardProps) => {
  ...
  const getBannerGradient = () => {
    switch (theme) {
      case 'Découverte': return 'from-blue-300 to-blue-400';
      case 'Bourbon': return 'from-amber-300 to-amber-400';
      case 'Racine': return 'from-green-400 to-green-500';
      case 'Saison': return 'from-purple-300 to-purple-400';
    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-6">
        ...
        {banner && banner.is_active && bannerMessages.length > 0 && (
          <div className={`bg-gradient-to-r ${getBannerGradient()} text-white px-3 py-1.5 rounded-lg text-center text-xs font-medium mb-3 -mt-2 overflow-hidden`}>
            <div 
              key={bannerIndex}
