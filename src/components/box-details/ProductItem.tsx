...
const ProductItem = ({ 
  ...
  const getProductImage = (productName: string) => {
    ...
    if (name.includes('miel') || name.includes('honey')) {
      return 'https://images.unsplash.com/photo-1587049633312-d628ae50a8ae?w=100&h=100&fit=crop';
    }
    if (name.includes('rhum') || name.includes('alcool')) {
      return 'https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=100&h=100&fit=crop';
    }
    if (name.includes('tisane') || name.includes('thé')) {
      return 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=100&h=100&fit=crop';
    }
    if (name.includes('piment')) {
      return 'https://images.unsplash.com/photo-1583076962938-713add2bf882?w=100&h=100&fit=crop';
    }
    if (name.includes('confiture') || name.includes('jam')) {
      return 'https://images.unsplash.com/photo-1486893732792-ab0085cb2d43?w=100&h=100&fit=crop';
    }
    if (name.includes('bonbons') || name.includes('chocolat')) {
      return 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=100&h=100&fit=crop';
    }
    if (name.includes('huile') || name.includes('essence')) {
      return 'https://images.unsplash.com/photo-1615735487485-e52b9af610c1?w=100&h=100&fit=crop';
    }
    ...
    if (name.includes('café')) {
      return 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=100&h=100&fit=crop';
    }
    if (name.includes('bière')) {
      return 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=100&h=100&fit=crop';
    }
    if (name.includes('biscuit')) {
      return 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=100&h=100&fit=crop';
    }
    // Default image for unknown products
    return 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=100&h=100&fit=crop';
  };
