  ...
  return <section className="py-16 bg-leaf-yellow text-white">
      <div className="container-section py-[15px]">
        <div className="max-w-3xl mx-auto text-center fade-in">
          ...
          <p className="text-xl mb-8 text-slate-900">Vous avez commandé votre box ? Votre avis nous intéresse. Rejoignez-nous sur les réseaux sociaux et partagez-nous votre expérience, votre unboxing, la réaction de vos proches, de votre famille, de la personne qui l'a reçue. Filmez ce moment et faîtes-nous en profiter !                                    </p>
