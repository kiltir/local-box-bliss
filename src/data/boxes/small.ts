...
export const smallBox: BoxData = {
  ...
  products: [
    ...
    { 
      ...
      dimensions: { width: 16, height: 10, depth: 5 },
      weight: 0.05
    },
    { 
      name: "Pot de miel", 
  ...
  themes: {
    'Découverte': {
      ...
      products: [
        ...
        { name: "Sachet de thé artisanal", quantity: "50g", producer: "Maison du Thé", weight: 0.05, dimensions: { width: 16, height: 10, depth: 5 } },
